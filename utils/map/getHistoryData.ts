    ...
    const response = await fetch(
      'http://185.32.84.190/api/kzh-map-ranges?start-year=0&end-year=2030',
      {
        ...
        headers: {
          ...
          Authorization:
            'Bearer eyJhbGciOiJIUzI1NiJ9.eyJyb2xlcyI6IlVTRVIiLCJlbWFpbCI6InllQG1haWwuY29tIiwic3ViIjoieWUiLCJpYXQiOjE3MzcwMTcxMzksImV4cCI6MTczNzEwMzUzOX0.yaXhLJNHh-f2KSaYSN5tT7L_R0dSRIQzL0QAcn5DyYI',
        },
      }
    )
