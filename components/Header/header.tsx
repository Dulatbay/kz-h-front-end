export default function Header(){
    ...
    return (
        <div className="h-20 bg-[#282828] max-sm:flex max-sm:justify-end max-sm:items-center">
            ...
            <div className="sm:h-full flex sm:flex-row sm:items-center sm:justify-around max-sm:invisible max-sm:opacity-0 sm:static
            peer-checked/navbar:visible peer-checked/navbar:opacity-100 max-sm:transition-all max-sm:duration-150  peer-checked/navbar:max-sm:top-16 top-14 flex-col h-screen bg-[#282828] w-screen fixed items-start px-8">
                ...
                <div className="hidden sm:flex gap-3 items-center">
                    <div id="streak" className="flex gap-1">
                        <h3 className="text-sm text-[#F66F3E]">22</h3>
                    ...
                    <a href="/profile">
                        <img alt="profile_pic" className="bg-[#B1B1B1] rounded-full h-8 w-8 aspect-square "/>
                    </a>
                </div>
            </div>
        </div>
