export default function Header(){
    ...
    return (
        <div className="h-20 bg-[#282828] max-sm:flex max-sm:justify-end max-sm:items-center">
            ...
            peer-checked/navbar:visible peer-checked/navbar:opacity-100 peer-checked/navbar:max-sm:top-16 transition-all duration-150 top-14 flex-col h-screen bg-[#282828] w-screen fixed items-start px-8">
                ...
                <div className="hidden sm:flex gap-3 items-center">
                    ...
                    <a href="/profile">
                        <img alt="profile_pic" className="bg-[#B1B1B1] rounded-full h-8 aspect-square"/>
                    </a>
                </div>
            </div>
        </div>
