...
export default function Profile(){
    ...
    const [userData, setUserData] = useState({"id": "6787c281b73c4f5aff016e50",
                    "fullName": null,
                    "username": "",
                    "imageUrl": null,
                    "email": "",
    ...
    switch(svg){
        ...
        case "score":
            return (
                ...
                <path d="M16.82 2H7.18001C5.05001 2 3.32001 3.74 3.32001 5.86V19.95C3.32001 21.75 4.61001 22.51 6.19001 21.64L11.07 18.93C11.59 18.64 12.43 18.64 12.94 18.93L17.82 21.64C19.4 22.52 20.69 21.76 20.69 19.95V5.86C20.68 3.74 18.95 2 16.82 2Z" stroke="#2CBB5D" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M9.59003 11L11.09 12.5L15.09 8.5" stroke="#2CBB5D" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
            )
        case "questions":
            return (
                ...
                <path d="M16.2222 1H3.77778C2.8 1 2 1.95 2 3.11111V17.8889C2 19.05 2.8 20 3.77778 20H16.2222C17.2 20 18 19.05 18 17.8889V3.11111C18 1.95 17.2 1 16.2222 1ZM11.7778 15.7778H5.55556V13.6667H11.7778V15.7778ZM14.4444 11.5556H5.55556V9.44444H14.4444V11.5556ZM14.4444 7.33333H5.55556V5.22222H14.4444V7.33333Z" fill="#F66F3E"/>
                </g>
                <defs>
        ...
        case "accuracy":
            return (
                ...
                <path d="M9 0C4.02931 0 0 4.02931 0 9C0 13.9707 4.02931 18 9 18C13.9707 18 18 13.9707 18 9C18 4.02931 13.9707 0 9 0ZM9 15.6774C5.30964 15.6774 2.32258 12.6911 2.32258 9C2.32258 5.30964 5.30891 2.32258 9 2.32258C12.6904 2.32258 15.6774 5.30891 15.6774 9C15.6774 12.6904 12.6911 15.6774 9 15.6774ZM9 4.35484C6.43464 4.35484 4.35484 6.43464 4.35484 9C4.35484 11.5654 6.43464 13.6452 9 13.6452C11.5654 13.6452 13.6452 11.5654 13.6452 9C13.6452 6.43464 11.5654 4.35484 9 4.35484ZM9 11.3226C7.71931 11.3226 6.67742 10.2807 6.67742 9C6.67742 7.71931 7.71931 6.67742 9 6.67742C10.2807 6.67742 11.3226 7.71931 11.3226 9C11.3226 10.2807 10.2807 11.3226 9 11.3226Z" fill="#FE4346"/>
                </svg>
            )
    }
}

function Stat({svg, textColor, stat, title}: {svg : "fire" | "score" | "questions" | "accuracy", textColor: string, stat: string, title: string}){
    return (
