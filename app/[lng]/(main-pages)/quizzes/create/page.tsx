        ...
        <div className="w-full max-w-[1200px] mx-auto flex flex-col px-8 items-center">
            ...
            <div className="w-full flex gap-3">
                <div className="w-1/2 flex flex-col gap-4">
                    <input id="titleInput" className="h-10 bg-[#FFFFFF24] w-full text-[#91898C] rounded-md pl-3"
                           type="text" placeholder="Title"/>
                    <textarea id="descArea" className="h-40 bg-[#FFFFFF24] w-full text-[#91898C] rounded-md pl-3"
                    ...
                    optionInputs.map((optionInput, index) => {
                        ...
                        return (
                            <div key={`option${optionInput.id}`} className="flex w-full relative">
                                ...
                                }} className={`p-2 text-white w-16 ${optionColor}`}>{text}</button>
                                <input type="text" id={`optionInput${optionInput.id}`}
                                       className="flex-1 px-2 bg-[#282828] text-[#91898C]"/>
                                <button onClick={() => {
                                    setOptionInputs(optionInputs => optionInputs.filter((s, i) => (i != index)));
                                }}
