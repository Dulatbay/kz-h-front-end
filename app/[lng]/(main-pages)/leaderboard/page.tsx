                            ...
                            leaders.map((row, i) => {
                                ...
                                return (
                                    <tr key={"row" + i} className="odd:bg-zinc-800 h-16 font-bold">
                                        ...
                                        <td><div className="flex gap-2 h-full items-center"><img src={row.img} className="bg-neutral-700 rounded-full w-8 aspect-square"/><a href={`/profiles/${row.username}`}>{row.name}</a></div></td>
                                        <td>{row.questions}</td>
