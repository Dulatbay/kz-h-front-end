...
function Head() {
  let imgs =
    'https://www.figma.com/file/AiJWvz95uhBS2KAeVOFQfm/image/c22d071fb0fe1d988f8eb36efbb887789e183504'
  return (
    <>
            ...
            >
              ...
              <div className="flex gap-3">
                <div className="flex gap-2 items-center">
                  {' '}
                  <QuestionsSVG /> {modul.questionsNumber} вопросов
                </div>
                <div className="flex gap-2 items-center">
                  {' '}
                  <ClockSVG /> {modul.duration}
                </div>
                <div className="flex gap-2 items-center">
                  {' '}
                  <UserSVG /> {modul.usersNumber} пользователей
                </div>
              </div>
              <div className="flex justify-between">
                <div className="flex gap-2 items-center">
                  ...
                  {difficultyArray.map((e, index) => {
                    return <LightningSVG key={'LightningSVG' + index} />
                  })}
                </div>
